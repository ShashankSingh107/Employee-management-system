...
class Employee extends Person{
    double salary;
    private static final double hra_percent= 0.40;  //40% hra
    private static final double ta_percent= 0.016;
    private static final double da_percent= 0.05;
    private static final double it_percent= 0.10;
    ...
    public double calculateSalary(){
        double hra= salary*hra_percent;
        double ta= salary*ta_percent;
        double da= salary*da_percent;
        double itax= salary*it_percent;

        double net_salary=salary+hra+ta+da-itax;
        return net_salary;
    }
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            try (PreparedStatement ps = con.prepareStatement(sql)) {
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    ...
                    //can print the allowences and tax
